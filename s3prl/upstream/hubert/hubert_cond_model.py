...
from ..wav2vec2.wav2vec2_cond_model import TransformerCondEncoder

from ..wav2vec2.film_blocks import FiLM, DoubleFiLM, ConditionalBatchNorm
from ..wav2vec2.ctc import CTC
...
class HubertCondModel(torch.nn.Module):
    def __init__(
        self,
        cfg: HubertConfig,
    ...
    def forward(
        ...
        x, layer_results, loss_interctc = self.encoder(
            x,
